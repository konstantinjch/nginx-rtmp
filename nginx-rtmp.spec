...
%changelog
* Mon Sep 13 2014 VKarandin <konstantinjch@mail.ru> - 1.7.4-1
- Update Nginx to 1.7.4

* Mon Apr 14 2014 Lars Kiesow <lkiesow@uos.de> - 1.5.13-1
- Update Nginx to 1.5.13
- Update RTMP module to 1.1.4

* Sun Jun  2 2013 Lars Kiesow <lkiesow@uos.de> - 1.2.8-5
- Updated rtmp module to 1.0.0

* Mon May 27 2013 Lars Kiesow <lkiesow@uos.de> - 1.2.8-4
- Updated rtmp module to 0.9.20
